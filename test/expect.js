...
describe('expect', function () {
  ...
  describe('safeguards', function () {
    ...
    describe('length guard', function () {
      let fnLengthDesc = Object.getOwnPropertyDescriptor(
        function () {},
        'length'
      );
  ...
  it('asyncGeneratorFunction', function () {
    ...
    err(function () {
      expect(async function* () {}, 'blah').to.not.be.a(
  ...
  it('nested.property(name, val)', function () {
    ...
    expect({foo: {bar: 'baz'}}).to.not.have.nested.property('foo.bar', 'quux');
    expect({foo: {bar: 'baz'}}).to.not.have.nested.property('foo.quux', 'baz');
  ...
  it('ownPropertyDescriptor(name)', function () {
    ...
    err(function () {
      ...
      expect(obj).to.have.ownPropertyDescriptor(
        'test',
        wrongDescriptor,
        'blah'
      );
  ...
  it('include()', function () {
    ...
    }, 'the given combination of arguments (undefined and number) is invalid for this assertion. ' + 'You can use an array, a map, an object, a set, a string, or a weakset instead of a number');
