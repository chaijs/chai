...
module.exports = function (chai, _) {
   ...
   *
   * Please note, that if you're using a transpiler, such as Babel
   * or TypeScript, then subclassing built-in objects, such as
   * Array, Error, Map, etc may not work with `instanceof`. This
   * is documented in the transpiler docs:
   ...
   * 
   * Please note, that if you're using a transpiler - such as Babel or TypeScript
   * - and you're subclassing `Error`, then passing a constructor to `.throws()`
   * will likely not work, due to inconsistencies between ES5 and ES6 environments.
   * This is documented in the transpiler docs:
   * ([Babel](https://babeljs.io/docs/usage/caveats/#classes))
   * ([TypeScript](https://github.com/Microsoft/TypeScript/wiki/Breaking-Changes#extending-built-ins-like-error-array-and-map-may-no-longer-work)
   * 
