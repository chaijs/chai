...
module.exports = function (chai, _) {
  ...
  function assertLeast (n, msg) {
    ...
    if (!(nType === 'number' || nType === 'date')) {
      var shoudBeType = (objType === 'number' || objType === 'date' )
        ...
        : 'number or date';
      throw new AssertionError(
        msgPrefix + 'the argument to least must be a ' + shoudBeType,
        undefined,
        ssfi
      );
    }
    ...
    if (!doLength && objType !== nType) {
      throw new AssertionError(
        msgPrefix + 'type mismatch, expected to least value to be a ' + objType,
        undefined,
        ssfi
      );
    }
  ...
  function assertMost (n, msg) {
    ...
    if (!(nType === 'number' || nType === 'date')) {
      var shoudBeType = (objType === 'number' || objType === 'date' )
        ...
        : 'number or date';
      throw new AssertionError(
        msgPrefix + 'the argument to most must be a ' + shoudBeType,
        undefined,
        ssfi
      );
    }
    ...
    if (!doLength && objType !== nType) {
      throw new AssertionError(
        msgPrefix + 'type mismatch, expected to most value to be a ' + objType,
        undefined,
        ssfi
      );
    }
  ...
  Assertion.addMethod('within', function (start, finish, msg) {
    ...
    if (startFailedTypeCheck || finishFailedTypeCheck) {
      var shoudBeType = (objType === 'number' || objType === 'date' )
        ? objType + 's'
        : 'numbers or dates';
      throw new AssertionError(
        msgPrefix + 'the arguments to within must be ' + shoudBeType,
        undefined,
        ssfi
      );
    }

    if (doLength && (startType === 'date' || finishType === 'date')) {
      throw new AssertionError(
    ...
    if (!doLength && (objType !== startType || objType !== finishType)) {
      throw new AssertionError(
        msgPrefix + 'type mismatch, expected to within values to be ' + objType + 's',
        undefined,
        ssfi
      );
    }
