...
function assert(express, errmsg) {
  var test = new Assertion(undefined, undefined, chai.assert, true);
  test.assert(
      express
    , errmsg
...
assert.isAbove = function (valueToCheck, valueToBeAbove, message) {
  new Assertion(valueToCheck, message, assert.isAbove, true).to.be.above(valueToBeAbove);
};
...
assert.isAtLeast = function (valueToCheck, valueToBeAtLeast, message) {
  new Assertion(valueToCheck, message, assert.isAtLeast, true).to.be.least(valueToBeAtLeast);
};
